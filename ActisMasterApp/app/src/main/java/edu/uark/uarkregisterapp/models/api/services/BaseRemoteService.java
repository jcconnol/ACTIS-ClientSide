...
abstract class BaseRemoteService {
	...
	URL buildPath(String recordId) {
		return this.buildPath((new PathElementInterface[0]), recordId);
	}
	...
	private static final String BASE_URL = "https://phone-to-rpi-service.herokuapp.com/api/";
